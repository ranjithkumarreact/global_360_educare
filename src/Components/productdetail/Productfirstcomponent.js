...
const ProductCarousel = () => {
  ...
  useEffect(() => {
    const Productdetails = async () => {
      const response = await axios.post(apiurl + "productdetail", {
        product_id: product_id,
      });
      setProductdetails(response.data.records);
      setProductimages(response.data.records.product_images);
      setMainImage(response.data.records.thumb_image);
    };
    Productdetails();
  }, [product_id]);
  ...
  return (
    <section className="products_details_main pt-5 pb-5">
      <div className="container">
        <div className="row">
          <div className="col-lg-5 col-md-12 col-sm-12 left_col">
          ...
          <div className="col-lg-7 col-md-12 col-sm-12 right_col">
